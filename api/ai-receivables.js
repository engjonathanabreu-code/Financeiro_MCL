module.exports=async function handler(req,res){
 ...
 try{
  ...
  if(mode==='clients'){
   ...
   prompt='Leia integralmente este relatório bancário de carteira de cobrança da MCL. Extraia SOMENTE os títulos/boletos liquidados/pagos, uma linha por boleto. Preserve Pagador, CPF/CNPJ, Nosso Número e Documento exatamente como aparecem. Datas devem ser YYYY-MM-DD. Valor nominal e liquidado devem ser números. Ignore linhas TOTAL/DIFERENÇA/QUANTIDADE. Não deduza nem invente dados.';
  }
